...
from paffsteam.exceptions import ApiException, CaptchaRequired, InvalidCredentials
from paffsteam.models import SteamUrl
from paffsteam.utils import create_cookie
...
class LoginExecutor:
    ...
    def _perform_redirects(self, response_dict: dict) -> None:
        ...
        for pass_data in parameters:
            ...
            self.session.post(pass_data['url'], params=pass_data['params'])
